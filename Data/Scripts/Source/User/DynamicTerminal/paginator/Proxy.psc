Scriptname DynamicTerminal:Paginator:Proxy extends Quest Conditional
...
{Called when an event causes the paginator to recalculate these values which means the proxy needs to update them or risk breaking the terminal display.}
	...
	DynamicTerminal:Paginator:Proxy:Logger.logState(self, actualPaginator, sPaginatorAction)
EndFunction
